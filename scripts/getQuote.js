(function(){
  ...
  //check if its a new day, if it is then get a new quote and save it to local storage
  //if not, then load quote from local storage.
  if(!localStorage.dayNum || dayNum - localStorage.dayNum > 0){
    getAjax(`https://juststoic.herokuapp.com/api/quotes/${dayNum}`,(serverQuote)=>{
